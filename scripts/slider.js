...
var multiItemSlider = (function() {
    return function(selector, config) {
        var
            ...
            _sliderWrapper = _mainElement.querySelector('.slider'), // обертка для .slider-item
            _sliderItems = _mainElement.querySelectorAll('.slider--container-item'), // элементы (.slider-item)
...
var slider = multiItemSlider('.slider--container')